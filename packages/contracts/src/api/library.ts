...
// enters CapyDesign (clipper capture, manual upload, agent-task upload or
 ...
 *   LIBRARY_DIR (clipper capture, `capt library import`, independent sources).
 ...
 * Library "Download as Figma" action and the `capt library figma` CLI command.
 */
 ...
 * button, and `capt library sync`). Reconcile registers *referenced* Library rows
...
// and `capt library import`) are restricted to design-relevant resources —
