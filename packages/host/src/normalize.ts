 ...
 */
export function normalizeCapyDesignHostProjectImportResult(input: unknown): CapyDesignHostProjectImportResult {
  if (!isRecord(input)) {
 ...
 */
export function normalizeCapyDesignHostProjectReplaceWorkingDirResult(
  input: unknown,
): CapyDesignHostProjectReplaceWorkingDirResult {
  if (!isRecord(input)) {
 ...
 */
export function normalizeCapyDesignHostPickWorkingDirResult(
  input: unknown,
): CapyDesignHostPickWorkingDirResult {
  if (!isRecord(input)) {
