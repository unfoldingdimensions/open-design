...
describe("launcher desktop handoff descriptors", () => {
  const prepared: LauncherDesktopHandoffDescriptor = {
    ...
    namespace: "release-beta",
    outer: {
      executablePath: process.platform === "win32" ? "C:\\Program Files\\CapyDesign Beta\\CapyDesign Beta.exe" : "/Applications/CapyDesign Beta.app/Contents/MacOS/CapyDesign Beta",
      pid: 4321,
    },
    payloadExecutablePath: process.platform === "win32" ? "C:\\od-data\\payload\\CapyDesign Beta.exe" : "/tmp/od-data/payload/CapyDesign Beta.app/Contents/MacOS/CapyDesign Beta",
