...
// tsconfig does not resolve the `@capydesign/contracts/api/chat` subpath
...
} from '@capydesign/contracts/api/finalize';
...
// canonical definitions live in @capydesign/contracts/api/finalize
