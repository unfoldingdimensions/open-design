...
import type { CritiqueConfig, PanelEvent } from '@capydesign/contracts/critique';
import { panelEventToSse } from '@capydesign/contracts/critique';
...
const tracer = trace.getTracer('@capydesign/daemon/critique');
