...
import type { CritiqueConfig, DegradedReason, PanelEvent, PanelistRole } from '@capydesign/contracts/critique';
import { CRITIQUE_PROTOCOL_VERSION, defaultCritiqueConfig } from '@capydesign/contracts/critique';
