...
// Locations:
//
//   packaged (mac):    ~/Library/Application Support/CapyDesign Prerelease/installation.json
//   packaged (win):    %APPDATA%/CapyDesign Prerelease/installation.json
//   packaged (linux):  $XDG_CONFIG_HOME/CapyDesign Prerelease/installation.json
