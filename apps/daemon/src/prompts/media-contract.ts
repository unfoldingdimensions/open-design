...
CapyDesign-owned media execution is **disabled for this run**. Do not call
...
**Default recipe — use CapyDesign's scaffold, don't write from scratch.**
...
# CapyDesign writes the required files itself; HyperFrames init is never run.
