...
// `status: 'planned'` so `capt plugin doctor` can warn rather than reject
...
export const FIRST_PARTY_ATOMS: ReadonlyArray<AtomCatalogEntry> = [
  ...
  { id: 'direction-picker',        label: 'Direction picker',        description: 'Host-owned visual catalog when explicitly requested.', status: 'implemented', taskKinds: ['new-generation', 'tune-collab'] },
