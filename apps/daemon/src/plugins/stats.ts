...
// Used by:
//
//   - `capt plugin stats` — operator at-a-glance inventory check,
//   - the desktop / web 'Plugins' settings panel (via the JSON
//     mode of the same CLI),
//   - the `capt doctor` summary (a future patch can fold this in
...
import type { InstalledPluginRecord, PluginSourceKind } from '@capydesign/contracts';
...
// `capt plugin sources` CLI; lives next to the other stats
