...
/**
 * Exact Codex 0.147.0 tuple replayed by CapyDesign against the installed CLI
...
/**
 * CapyDesign-owned best-effort replay for the exact native OpenCode tuple.
...
/**
 * CapyDesign-owned replay of the exact Claude 2.1.233 Agent stream-json
