...
// REASONIX_ACP_SYSTEM_APPEND. This ensures the model follows CapyDesign's
// design workflow (artifact output, design system, skill instructions)
// instead of treating every request as a pure coding task.
const DESIGN_INSTRUCTIONS = `# CapyDesign integration — MUST follow

You are running inside CapyDesign, a design tool. The user message contains
