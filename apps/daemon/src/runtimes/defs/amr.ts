...
import type { ModelCapability, ModelCost, ModelMetadata } from '@capydesign/contracts';
...
//      the link-facing slug (`deepseek-v3.2` / `glm-5.1`), so CapyDesign
...
function isVelaChatModelId(modelId: string): boolean {
  ...
  // but CapyDesign's AMR runtime currently drives only chat completions.
