// Contract test for the `capt project handoff` CLI surface. Keeps the
...
describe('capt project handoff CLI', () => {
  let stdout: string[];
  let stderr: string[];
  ...
  // Malformed flags must reach this structured fail() path. `capt project
