...
//
// Two contracts:
//   1. The Zod schema in @capydesign/contracts accepts the new
...
import { GenUISurfaceSpecSchema } from '@capydesign/contracts';
import { validateSafe } from '@capydesign/plugin-runtime';
