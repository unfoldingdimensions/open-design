...
describe('agent-driven brand extraction engine', () => {
  ...
  it('prefers source-backed human brand tokens over script/debug color noise', () => {
    const brand = brandFromMaterial({
      ...
      siteName: 'CapyDesign',
      title: 'CapyDesign',
      description: 'CapyDesign design system.',
      colors: [
      ...
      fontFiles: [],
      logos: [],
      headings: ['CapyDesign The Open-source Claude Design alternative'],
      paragraphs: ['CapyDesign is a local-first design platform.'],
      navLabels: [],
      extraPages: [],
      screenshot: null,
      thin: false,
