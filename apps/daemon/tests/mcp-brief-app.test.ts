...
describe('local CapyDesign MCP brief app', () => {
  ...
  it('keeps user-facing MCP copy on public CapyDesign product terms', () => {
    ...
    expect(userFacingCopy).toContain('CapyDesign Cloud');
