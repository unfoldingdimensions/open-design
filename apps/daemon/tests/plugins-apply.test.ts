...
import type { ContextItem, InstalledPluginRecord } from '@capydesign/contracts';
...
describe('applyPlugin', () => {
  ...
  it('does not require a registry roots argument (no FS access at apply time)', () => {
    ...
    const expectedDataDir = path.resolve(process.env.OD_DATA_DIR ?? path.join(process.cwd(), '.capydesign'));
