// Red-spec for the `capt files write` / `capt files upload` crash:
...
describe('capt files write / upload (ESM require regression)', () => {
  let stub: StubServer;
  ...
  // but inside its own try/catch — so instead of crashing, `capt project create
