  ...
  it('confirms a plugin share action before starting the GitHub repo task', async () => {
    mockedListPlugins.mockResolvedValue([
      ...
      makePlugin(
        ...
        'Creates a public GitHub repository for a local CapyDesign plugin using the GitHub CLI.',
      ),
      makePlugin(
        'od-plugin-contribute-open-design',
        'bundled',
        'bundled',
        'Contribute Plugin to CapyDesign',
        'Opens a pull request that adds a local CapyDesign plugin to the CapyDesign community catalog.',
      ),
    ]);
