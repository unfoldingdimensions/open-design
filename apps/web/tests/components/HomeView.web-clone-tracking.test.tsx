...
describe('web-clone example-card tracking', () => {
  ...
  // narrowed to the first-party CapyDesign site to avoid shipping third-party
  ...
  it('resolves exactly the contracted CapyDesign Website-clone site card', async () => {
    writeHomeGuideStage('done');
    stubPlugins();
    renderHome();
  ...
  it('renders the contracted CapyDesign site card with a local eager logo', async () => {
    writeHomeGuideStage('done');
    stubPlugins();
    renderHome();
  ...
  it('falls back when the local CapyDesign site card logo cannot load', async () => {
    writeHomeGuideStage('done');
    stubPlugins();
    renderHome();
