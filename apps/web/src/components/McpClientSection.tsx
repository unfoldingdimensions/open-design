...
//
// CapyDesign connects to the configured servers as a CLIENT and surfaces
...
import type { TrackingExternalMcpElement } from '@capydesign/contracts/analytics';
import {
  disconnectMcpOAuth,
  fetchMcpOAuthStatus,
  fetchMcpServers,
...
// so the most useful categories for CapyDesign (visual generation, then
