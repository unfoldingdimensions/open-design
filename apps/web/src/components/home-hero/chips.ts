...
import type { ProjectKind, ProjectMetadata } from '@capydesign/contracts';
import type { DefaultScenarioPluginId } from '@capydesign/contracts';
...
export const HOME_HERO_CHIPS: ReadonlyArray<HomeHeroChip> = [
  ...
  },
  {
    ...
    icon: 'edit',
    group: 'migrate',
    hint: 'Author a reusable CapyDesign plugin and add it to My plugins.',
