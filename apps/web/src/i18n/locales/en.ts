...
export const en: Dict = {
  ...
  'chat.runError.title.cliMissing': '{agent} not detected',
  'chat.runError.title.promptTooLarge': 'Conversation too long',
  'chat.runError.title.modelUnavailable': "This model is unavailable",
  'chat.runError.title.modelCapabilityUnsupported': "This model doesn’t support this task",
  'chat.runError.title.upstreamUnavailable': 'Model service unavailable',
  'chat.runError.title.toolLoop': 'Stuck in a loop',
  'chat.runError.title.outputInvalid': 'No valid reply generated',
  'chat.runError.title.runtimeConfig': "CapyDesign error",
  'chat.runError.title.apiKeyInvalid': 'Incomplete model settings',
  'chat.runError.cliMissingMessage': 'Check that {agent} is installed on this computer, then try again.',
  'chat.runError.promptTooLargeMessage': 'This conversation and its attachments exceed what the AI can process. Remove some attachments or start a new conversation, then try again.',
  ...
  'chat.runError.runtimeConfigMessage': 'Try generating again, or switch models and retry. If this keeps happening, contact support.',
  'chat.runError.apiKeyInvalidMessage': 'The API key is misconfigured. Re-enter it, then try again.',
  'chat.runError.title.quotaExhausted': "Quota exhausted",
  'chat.runError.title.timedOut': "Reply timed out",
  ...
  'chat.runError.agentReplyIncompleteMessage': "The agent's reply came back without the marker CapyDesign needs to record this step, so the task couldn't move on. Nothing you sent was lost — this one is intermittent, and retrying usually goes through.",
  'chat.runError.clarificationRepeatedMessage': "The agent asked for more detail a second time, but a task has room for only one round of questions, so it stopped here. Your answers are still in the conversation — retrying starts the request over, and folding the extra detail into it usually settles things in one round.",
  ...
  'chat.runError.clientEnvironmentCause.network': 'network unreachable',
  'chat.runError.clientEnvironmentCause.hostPolicy': 'blocked by a system policy',
  'chat.runError.clientEnvironmentCause.localStorage': 'local storage read/write failed',
  ...
  'settings.welcomeTitle': 'Welcome to CapyDesign',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. CapyDesign will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. CapyDesign reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingCloudTitle': 'Sign in to CapyDesign',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the CapyDesign daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to CapyDesign.',
  ...
  'settings.imageAgentDefaultLabel': 'Default image & vision agent',
  'settings.imageAgentDefaultHint': 'Used for image-generation & vision-review when a project has not set its own. Projects can override below the chat.',
  ...
  'settings.mcpServerHint': 'Expose CapyDesign as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the CapyDesign team',
  'settings.privacyConsentKicker': 'Help us improve CapyDesign',
  'settings.privacyConsentLead': 'Sharing usage data helps us understand how CapyDesign performs in real workflows, so we can improve the parts that matter most to your experience.',
  ...
  "settings.allowSilentUpdatesDesc": "When an in-app update is ready, install it automatically the next time CapyDesign starts. Does not upgrade the current session. Installer updates still ask first.",
  ...
  'settings.updateQuitFailed': 'The installer opened, but CapyDesign could not quit automatically.',
  ...
  'settings.mcpTitle': 'Connect CapyDesign to your coding agent',
  'settings.mcpHint': 'Use MCP to give supported agents access to your projects and design context.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure CapyDesign is running, then reopen this panel.',
  'settings.mcpBuildDaemon': 'Build the daemon first.',
  'settings.mcpNodeMissing': 'Node binary is missing.',
  'settings.mcpBuildHint': 'apps/daemon/dist/cli.js is missing. Run `pnpm --filter @capydesign/daemon build` and refresh.',
  ...
  'settings.mcpCapabilityDefault': 'Use the project and file currently open in CapyDesign as context.',
  'settings.mcpRunningNote': 'Keep CapyDesign running. Restart your coding agent after setup.',
  ...
  'entry.discordAria': 'Join our Discord for free credits',
  'entry.discordAriaWithOnline': 'Join the CapyDesign Discord - {online}',
  'entry.discordOnlineLabel': '{count} online',
  'entry.xAria': 'Follow @OpenDesignHQ for updates',
  ...
  'entry.followLinkedinLabel': 'Follow CapyDesign on LinkedIn',
  'entry.followXiaohongshuLabel': 'Follow CapyDesign on Xiaohongshu',
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable CapyDesign plugin and add it to My plugins.',
  ...
  'handoff.promptIntro': 'Continue from this local CapyDesign project folder:',
  ...
  'designSystemPicker.noPreview': 'No preview page. CapyDesign Systems to view the full preview.',
  ...
  'pluginsHome.subtitle': 'Ready-to-use CapyDesign workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with CapyDesign and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to CapyDesign',
  'pluginCard.contributeTitle': 'Contribute plugin to CapyDesign with a pull request',
  ...
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use CapyDesign from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure CapyDesign is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use CapyDesign everywhere',
  'useEverywhere.modalTitle': 'Use CapyDesign everywhere',
  'useEverywhere.modalSubtitle': 'Drop CapyDesign into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'CapyDesign works wherever your agent works',
  'useEverywhere.section.overview.intro': 'CapyDesign is more than a window — it is a local privileged daemon (`capt`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `capt <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires CapyDesign as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without CapyDesign at all.',
  ...
  'useEverywhere.section.cli.heading': 'Drive CapyDesign from any shell',
  'useEverywhere.section.cli.intro': 'The `capt` bin ships with the daemon and is the same binary used by Claude Code / Codex when they run a generation. Most subcommands are thin clients that POST to the local daemon, so they work the same whether you launched it via `pnpm tools-dev` or as a packaged app.',
  'useEverywhere.section.cli.bullet1': '`capt` (no args) — boots the daemon and opens the web UI.',
  'useEverywhere.section.cli.bullet2': '`capt media generate ...` — produce image / video / audio bytes through the unified media protocol.',
  'useEverywhere.section.cli.bullet3': '`capt run ...` — start a project run from a prompt + skill.',
  'useEverywhere.section.cli.bullet4': '`capt plugin install <source>` / `capt plugin apply <id>` — install and apply community plugins.',
  'useEverywhere.section.cli.bullet5': '`capt skills list` / `capt design-systems list` — inspect what is available locally.',
  'useEverywhere.section.cli.bullet6': '`capt status` / `capt doctor` — verify daemon health and detect agent CLIs on your PATH.',
  ...
  'useEverywhere.section.mcp.heading': 'Expose CapyDesign as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'CapyDesign ships with a Model Context Protocol server (`capt mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover CapyDesign tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  'useEverywhere.section.mcp.bullet1': 'Stdio transport — no extra port, the client spawns `capt mcp` directly.',
  ...
  'useEverywhere.section.mcp.footer': 'In the CapyDesign app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  'useEverywhere.section.http.tab': 'HTTP API',
  'useEverywhere.section.http.heading': 'Same REST + SSE surface the web UI uses',
  'useEverywhere.section.http.intro': 'The local daemon serves an HTTP API at `http://127.0.0.1:7456` (port configurable). Every endpoint the web UI calls is also fair game for your scripts. Streaming endpoints (chat turns, project runs) emit Server-Sent Events with the contract types in `@capydesign/contracts`.',
  ...
  'useEverywhere.section.http.footer': 'Pure TypeScript types for every request/response live in `@capydesign/contracts` — import them in your script for full autocomplete without wiring a generator.',
  'useEverywhere.section.skills.tab': 'Skills & headless',
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without CapyDesign running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). CapyDesign extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside CapyDesign and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.bullet4': 'Headless: an agent with `capt` on its PATH can call `capt skills list` then run any skill; the daemon is optional for read-only flows.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + CapyDesign extras)',
  ...
  'entry.githubStarAria': 'Star CapyDesign on GitHub',
  ...
  'newproj.locationDefault': 'CapyDesign projects',
  ...
  'socialShare.openDesignSection': 'Share CapyDesign',
  'socialShare.openDesignTitle': 'CapyDesign on GitHub',
  'socialShare.openDesignText': 'CapyDesign is a source-available workspace for creating, editing, deploying, and handing off design artifacts.',
  ...
  'socialShare.projectText': 'Built with CapyDesign: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with CapyDesign: {title}\n{url}\nCapyDesign repo: {repo}',
  ...
  'project.imageAgentTooltip': 'Image & vision agent for this project',
  'project.imageAgentSection': 'Image & vision agent',
  'project.imageAgentAuto': 'Main chat agent',
  'project.imageAgentAutoHint': 'Image work runs on this project\'s main chat agent',
  'project.imageAgentInstalled': 'Installed',
  'project.imageAgentNotInstalled': 'Not installed',
  ...
  'chat.attachmentFolderUnsupported': "Folders can't be attached here. Attach the files inside instead.",
  ...
  'chat.forkConversationFailed': 'Could not start a new conversation.',
  ...
  'brandEnrichment.body': "CapyDesign will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  ...
  'chat.you': 'You',
  'chat.record.retryImage': '{count} of the illustrations failed to generate — please try those again',
  'chat.quote.add': 'Add to chat',
  'chat.quote.count': '{count} notes',
  'chat.quote.duplicate': 'Already added to the chat',
  'chat.quote.removeAria': 'Remove notes',
  'chat.support.title': 'Contact support',
  'chat.support.join': 'Join',
  'chat.sendFailedRetryAria': 'Send failed — retry',
  'chat.audio.play': 'Play',
  'chat.audio.pause': 'Pause',
  'chat.audio.download': 'Download {name}',
  'chat.upgrade.balance': 'Balance left',
  'chat.upgrade.whyLow': 'This may not cover the next task — running out midway leaves it half-finished',
  'chat.upgrade.whyOut': 'You can’t start a new task right now',
  ...
  'chat.activeFilePlaceholder': 'Ask CapyDesign to change {file}...',
  ...
  'chat.mode.design.solves': 'Use it when you want CapyDesign to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  ...
  'chat.queuedSteerClosed': 'This turn already stopped reading input',
  'chat.queuedSteerFailed': 'Couldn’t steer the turn',
  'chat.queuedSteerTextOnly': 'Only text fits into a running turn — send this one with its attachments separately',
  ...
  'preview.shareTextDefault': 'CapyDesign template: {title}',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure CapyDesign is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.usefulInfoTip18': 'Subscribe to CapyDesign on YouTube for tutorials and demos.',
  'designFiles.usefulInfoTip19': 'Follow CapyDesign on LinkedIn for product news.',
  'designFiles.usefulInfoTip20': 'Follow CapyDesign on Xiaohongshu for tips and inspiration.',
  ...
  'fileViewer.exportDaemonUnreachable': 'Could not reach the daemon. Please try again.',
  ...
  "assistant.feedbackReasonTitleNegative": "What went wrong?",
  "assistant.feedbackDiscordNegative": "Share more context in {discord} so the team can understand what went wrong and follow up directly.",
  "assistant.feedbackDiscordPositive": "Share what you made with the {discord} community, or drop a screenshot and tell us what worked well.",
  ...
  'assistant.feedbackReasonNegativeMissed': 'Did not follow my request',
  'assistant.feedbackReasonNegativeVisual': 'Visual inconsistency',
  'assistant.feedbackReasonNegativeIncomplete': 'Incomplete output',
  'assistant.feedbackReasonNegativeHard': 'Hard to use',
  'assistant.feedbackReasonNegativeCouldNotRun': 'Could not run',
  'assistant.feedbackReasonNegativeTooSlow': 'Too slow',
  'assistant.feedbackReasonNegativeDesignSystem': 'Did not follow the design system',
  'assistant.feedbackReasonOther': 'Other',
  'assistant.feedbackReasonPlaceholder': 'Add something (optional)',
  ...
  'chat.runError.actionBlocked.readOnly': "You have read-only access to this project, so you can't start a new run.",
  'chat.runError.actionBlocked.messagesUnavailable': "This conversation's messages didn't load, so this run can't be retried yet.",
  'chat.runError.actionBlocked.billing': "Still resolving which workspace pays for this project. Try again in a moment.",
  ...
  'assistant.designSystemDirectionLocked': 'Active design system selected. Visual direction is already locked.',
  ...
  'assistant.statusWorking': 'Working',
  'assistant.statusRunningTool': 'Running a tool',
  'assistant.activityJustNow': 'just now',
  'assistant.activitySecondsAgo': '{s}s ago',
  'assistant.statusStreaming': 'Streaming',
  'assistant.statusCompactingContext': 'Compacting context',
  ...
  "chat.attachments.scrollPrev": "Show previous attachments",
  "chat.input.collapse": "Collapse",
  "chat.input.expandFull": "Show full message",
  ...
  "chat.edge.reconnectFailed": "Network connection not restored",
  "chat.edge.reconnecting": "Restoring network connection",
  "chat.edge.retrying": "Retrying",
  "qf.visualNext": "Next style",
  "qf.visualPrev": "Previous style",
  "qf.visualRandom": "Random",
  "qf.visualReshuffle": "Shuffle",
  "qf.visualViewFan": "Stack back up",
  "qf.visualViewGrid": "Show as grid",
  "qf.confirmed": "Confirmed",
  "qf.picked": "{count} picked",
  "qf.moreOptions": "More options",
  "qf.colorPresets": "Preset colors",
  "qf.colorCustom": "Custom color",
  "qf.colorPickerLabel": "Open the color picker",
  "qf.colorHexLabel": "Hex color value",
  "qf.colorPreview": "Preview: this is how the accent color looks in the interface.",
  "qf.colorInvalid": "Enter a 6-digit hex color, for example #3b82f6",
  'qf.choose': 'Choose…',
  'qf.customLabel': 'Custom answer',
  'qf.customPlaceholder': 'Type your own answer...',
  'qf.otherOption': 'Other',
  'qf.ownAnswer': 'Write your own',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with CapyDesign — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with CapyDesign — no download needed.',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple CapyDesign project folders. New projects are saved as one folder inside the selected base.',
  ...
  'settings.customInstructionsHint': 'Fixed instructions CapyDesign should follow in every chat. Save facts, preferences, and project context as memories.',
  ...
  'settings.memoryStarterProjectDesc': 'CapyDesign v0.5 — chat-driven design editor',
  ...
  'updater.availableBody': 'CapyDesign {version} is available. It will download before the installer can open.',
  'updater.activeRunsTitle': 'CapyDesign is still working',
  'updater.activeRunsBody': '{count} active tasks are still running. Restarting now will interrupt them.',
  'updater.activeRunsUnknownBody': 'CapyDesign could not confirm whether tasks are still running. Restarting now may interrupt active work.',
  ...
  'updater.installerOpenBody': 'The installer is open. CapyDesign is quitting so you can finish the update.',
  ...
  'updater.dialogCheckFailed': 'Couldn\'t check for updates.\nVersion information is temporarily unavailable. Check your network connection and try again.',
  ...
  'updater.quitButton': 'Quit CapyDesign',
  'updater.quitFailedBody': 'The installer is open, but CapyDesign could not quit. Quit CapyDesign before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. CapyDesign will close and open the installer.',
  'updater.readyVersion': 'CapyDesign {version} is ready. CapyDesign will close and open the installer.',
  'updater.reinstallLearnMore': 'Learn more',
  'updater.reinstallReadyGeneric': 'This update requires a full reinstall. CapyDesign will close and open the installer.',
  'updater.reinstallReadyVersion': 'CapyDesign {version} requires a full reinstall. CapyDesign will close and open the installer.',
  ...
  'whatsNew.updatedTitle': 'CapyDesign {version} is here',
  ...
  'dsManager.createBody': 'Teach CapyDesign your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions CapyDesign follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach CapyDesign your design systems — extract one from a website, then apply it in any chat.',
  ...
  'onboarding.buildBody': 'CapyDesign turns your brand into a reusable design system — then keeps everything you build on-brand and consistent.',
  ...
  'campaign.deepseekV4Flash.ruleSummary': 'From Aug 13–27, paid users can use DeepSeek V4 Pro and V4 Flash for free in CapyDesign. Large-scale abuse may pause campaign access.',
  'campaign.deepseekV4Flash.windowLabel': 'Aug 13–27',
  'campaign.deepseekV4Flash.weekFreeSuffix': 'two weeks free',
  'campaign.deepseekV4Flash.boundary': 'Unlimited model quota and free generation counts in your plan apply only inside CapyDesign — not via MCP, CLI, API, or other surfaces. Final interpretation rests with CapyDesign. Some models may need to queue at peak hours.',
  ...
  'experienceSurvey.tag': "We'd love your feedback — help improve CapyDesign",
  'experienceSurvey.close': "Close",
  'experienceSurvey.recommendation': "How likely are you to recommend CapyDesign to a colleague or friend?",
  'experienceSurvey.recommendationLow': "Not at all likely",
  'experienceSurvey.recommendationHigh': "Extremely likely",
  'experienceSurvey.improvement': "Which one should we improve first?",
  'experienceSurvey.improvement.wrongOutput': "Not what I asked for",
  'experienceSurvey.improvement.falseDone': "Claimed done, nothing changed",
  'experienceSurvey.improvement.hardToUse': "Hard to use",
  'experienceSurvey.improvement.upgradePrompts': "Too many upgrade prompts",
  'experienceSurvey.improvement.stuck': "Gets stuck or fails",
  ...
  'experienceSurvey.improvement.other': "Something else",
  'experienceSurvey.otherPlaceholder': "Tell us in your own words",
  'experienceSurvey.submit': "Send",
  ...
  'chat.record.verb.read': "Read",
  'chat.record.verb.write': "Wrote",
  'chat.record.verb.edit': "Edited",
  'chat.record.verb.search': "Searched",
  ...
  'chat.record.thoughts': "Thoughts",
  'chat.record.done': "Done",
  'chat.record.failedTurn': "Run failed",
  'chat.record.plan': "Plan · {count} steps",
  'chat.record.planStep': "Step {current} of {total}",
  'chat.record.imageBatch': "Generating illustrations",
  ...
  'chat.record.audioBatch': "Generating audio",
  'chat.record.videoBatch': "Generating video",
  'chat.record.audioCount': "{count} clips",
  'chat.record.videoCount': "{count} videos",
  'chat.record.audioPending': "Generating audio…",
  'chat.record.videoPending': "Generating video…",
  'chat.record.viewAudio': "Open audio {index}",
  'chat.record.viewVideo': "Open video {index}",
  ...
  'chat.designSystemStatus.description': 'CapyDesign is using the setup sources to generate this project.',
  ...
  'labs.harnessHint': "Your next generation will use CapyDesign's latest strategy, with noticeably more polished results (beta)",
  'labs.harnessTooltip': "Switches to the agent harness CapyDesign built for design work. Output is noticeably better in layout, structure, and completeness.",
  ...
  'chat.record.unfinished': "Unfinished",
  'chat.pluginAction.failed': 'Plugin action failed.',
  'chat.pluginAction.saved': 'Plugin saved.',
  'chat.pluginAction.validationIssues': 'Plugin draft created with validation issues.',
  'chat.pluginAction.contributionStarted': 'CapyDesign contribution task started for {path}.',
  'chat.pluginAction.aria': 'Plugin next actions',
  'chat.pluginAction.title': 'Plugin ready',
  'chat.pluginAction.subtitle': 'Send the next step to the agent so it can run the capt CLI.',
  'chat.pluginAction.filesReady': '{count} files ready for personal plugins',
  'chat.pluginAction.install': 'Add to personal plugins',
};
