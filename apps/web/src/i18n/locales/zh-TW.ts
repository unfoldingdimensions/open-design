...
export const zhTW: Dict = {
  ...
  "chat.runError.title.cliMissing": "未偵測到 {agent}",
  "chat.runError.title.promptTooLarge": "對話內容過長",
  "chat.runError.title.modelUnavailable": "目前模型不可用",
  "chat.runError.title.modelCapabilityUnsupported": "目前模型不支援此任務",
  "chat.runError.title.upstreamUnavailable": "模型服務暫不可用",
  "chat.runError.title.toolLoop": "操作陷入循環",
  "chat.runError.title.outputInvalid": "未能產生有效回覆",
  "chat.runError.title.runtimeConfig": "CapyDesign 執行異常",
  "chat.runError.title.apiKeyInvalid": "模型設定不完整",
  "chat.runError.cliMissingMessage": "請確認這台電腦已安裝 {agent}，安裝完成後再試。",
  "chat.runError.promptTooLargeMessage": "目前對話和附件超過了 AI 可處理的長度，請減少附件或另開對話後再試。",
  ...
  "chat.runError.runtimeConfigMessage": "請嘗試重新產生，或更換模型後重試。如果問題持續出現，請聯絡支援。",
  "chat.runError.apiKeyInvalidMessage": "API key 設定錯誤，請重新填寫後重試。",
  "chat.runError.title.quotaExhausted": "額度已用盡",
  "chat.runError.title.timedOut": "等待回覆逾時",
  ...
  "chat.runError.agentReplyIncompleteMessage": "智慧體的回覆裡缺少 CapyDesign 記錄這一步所需的標記，任務因此沒能繼續。你提交的內容沒有遺失；這屬於偶發情況，重試一次通常就好了。",
  "chat.runError.clarificationRepeatedMessage": "智慧體還想再確認一些資訊，於是又問了一次；但一個任務只允許一輪提問，所以停在了這裡。你的回答仍然保留在對話裡——重試會把請求重新跑一遍，把要補充的資訊一起寫進去，通常一輪就能問清楚。",
  ...
  "chat.contextPrompt.referenceProject":
    "請把 CapyDesign 專案「{name}」作為參考上下文。它的本機路徑是：{path}。在設計或修改前，如有幫助請先搜尋並讀取這個目錄。",
  ...
  "settings.welcomeTitle": "歡迎使用 CapyDesign",
  "settings.welcomeSubtitle": "",
  "settings.onboardingCreateTitle": "從一句需求開始",
  "settings.onboardingCreateBody":
    "描述你想做的網站、應用、Deck、圖片或影片，CapyDesign 會建立專案，並保留可繼續編輯的產出。",
  ...
  "settings.onboardingMemoryCalloutBody":
    "這些回答會構成你的記憶檔案。CapyDesign 會在每個任務中重複使用它，並在你工作時持續學習。",
  ...
  "settings.onboardingCloudTitle": "登入 CapyDesign",
  ...
  "settings.agentInstall.pathHint":
    "如果你透過 npm 或 Homebrew 安裝了 CLI，但仍顯示為未安裝，請確認該工具的 bin 目錄已加入 CapyDesign daemon 繼承的 PATH（在 macOS 上，Terminal 與 GUI 應用的 PATH 可能不同）。請參閱 QUICKSTART.md（「Local agent CLI and PATH」章節）。",
  "settings.agentInstall.stepOpenLinks":
    "在目標代理卡片上開啟「安裝」或「文件」連結。",
  "settings.agentInstall.stepAuth":
    "返回 CapyDesign 前，請先在對應 CLI 完成驗證（登入或新增 API 憑證）。",
  ...
  "settings.dshSetupDescription": "CapyDesign 將透過這台電腦上的 dsh CLI 安裝連接元件。",
  "settings.dshSetupNote": "只安裝 CapyDesign 的 profile 元件。DeepSeek Harness 仍由你自行安裝和管理。",
  ...
  "settings.mcpServerHint":
    "將 CapyDesign 作為 MCP 伺服器暴露給你的編碼代理。",
  ...
  "settings.privacy": "隱私",
  "settings.privacyHint": "與 CapyDesign 團隊共享哪些資料",
  "settings.privacyConsentKicker": "協助我們改進 CapyDesign",
  "settings.privacyConsentLead":
    "分享使用資料後，我們能更了解 CapyDesign 在真實工作流裡的表現，並優先改進真正影響體驗的地方。",
  ...
  "settings.mcpTitle": "將 CapyDesign 連接至程式設計 agent",
  "settings.mcpHint": "透過 MCP，讓支援的 agent 存取您的專案與設計脈絡。",
  "settings.mcpDaemonError":
    "無法連線到本地守護程序以解析安裝路徑（{error}）。請確認 CapyDesign 正在執行，然後重新開啟此面板。",
  ...
  "settings.mcpCapabilityDefault":
    "將目前在 CapyDesign 中開啟的專案與檔案作為脈絡。",
  "settings.mcpRunningNote": "請保持 CapyDesign 執行。設定完成後，重新啟動程式設計 agent。",
  ...
  "entry.discordAria": "加入 Discord 社群，領取使用額度",
  "entry.discordAriaWithOnline": "加入 CapyDesign Discord - {online}",
  "entry.discordOnlineLabel": "{count} 在線",
  "entry.xAria": "追蹤 @OpenDesignHQ，掌握新功能",
  ...
  "entry.followLinkedinLabel": "在 LinkedIn 上追蹤 CapyDesign",
  "entry.followXiaohongshuLabel": "在小紅書上追蹤 CapyDesign",
  ...
  "messageCenter.subtitle": "CapyDesign 更新、平台公告和權益提醒",
  ...
  "goPlanSunset.closeAria": "關閉彈窗",
  "goPlanSunset.title": "關於停售 Go 訂閱的公告",
  "goPlanSunset.subtitle": "親愛的 CapyDesign 使用者：CapyDesign Go 上線後獲得許多關注與意見回饋。我們意識到目前 CapyDesign 在額度規則、產品體驗等方面仍有不足，對此深表歉意。",
  "goPlanSunset.decisionsAria": "公告決定",
  "goPlanSunset.decisionsIntro": "為了確保為大家提供最佳設計體驗，我們決定：",
  "goPlanSunset.decisionStopSales": "即日起停售 Go 新訂閱",
  "goPlanSunset.decisionRefund": "8 月 31 日前原路全額退款；退款後權益停止（入帳時間以付款管道為準）",
  "goPlanSunset.decisionUnaffected": "除 Go 之外的其他訂閱方案使用者不受影響",
  "goPlanSunset.closing": "感謝您的理解與支持，也感謝所有提出批評的使用者。我們將持續專注於更智慧的設計交付，讓每個人和每個團隊都能更好地交付滿意的設計作品！",
  "goPlanSunset.dismissError": "確認失敗，請再試一次。",
  "goPlanSunset.viewSubscriptions": "查看其他訂閱",
  ...
  "homeHero.chip.liveArtifact": "即時產物",
  ...
  "homeHero.chip.createPluginHint":
    "編寫可重複使用的 CapyDesign 外掛並將其加入「我的外掛」。",
  ...
  "handoff.promptIntro": "請基於這個 CapyDesign 專案的本機資料夾繼續實作：",
  ...
  "pluginsHome.subtitle":
    "隨附於此執行環境、可立即使用的 CapyDesign 工作流程。挑選一個以載入起始提示，或瀏覽登錄檔取得更多。",
  ...
  "pluginsHome.emptyCatalog":
    "目錄是空的。內建外掛隨 CapyDesign 一同提供，應會自動出現在此處 — 若問題持續發生，請嘗試重新啟動 daemon。",
  ...
  "pluginCard.contributeAria": "將 {title} 貢獻至 CapyDesign",
  "pluginCard.contributeTitle": "透過 pull request 將外掛貢獻至 CapyDesign",
  ...
  "integrations.lede":
    "連接外部系統，把 MCP 工具帶入智能體迴圈，並在其他 IDE、腳本與自動化流程中使用 CapyDesign。",
  ...
  "mcpClient.daemonError":
    "無法連線到本機 daemon。請確認 CapyDesign 正在執行，然後重新開啟此面板。",
  "mcpClient.saveFailed": "儲存失敗。請確認 daemon 正在執行後再試一次。",
  "useEverywhere.modalAria": "隨處使用 CapyDesign",
  "useEverywhere.modalTitle": "隨處使用 CapyDesign",
  "useEverywhere.modalSubtitle":
    "將 CapyDesign 接入任何 IDE、Agent 或指令碼 — CLI、HTTP、MCP 及 Skills。使用「複製 Agent 指南」並貼到 Claude Code、Codex、Cursor、openclaw 或 hermes 中，即可設定一切。",
  ...
  "useEverywhere.section.overview.bullet4":
    "Skills — 隨插即用的 `SKILL.md` 套件（相容於 Claude），任何已在您 PATH 上的 Agent 完全無需 CapyDesign 即可調用。",
  ...
  "useEverywhere.section.mcp.footer":
    "在 CapyDesign 應用程式中，開啟「設定 → 整合」即可複製特定用戶端的安裝指令（Cursor、Claude Code、Antigravity、VS Code），而無需手動編輯 JSON。",
  ...
  "useEverywhere.section.skills.intro":
    "Skill 是一個包含相容於 Claude 的 `SKILL.md`（YAML 前置資料 + 內文）的目錄。CapyDesign 以 `od:` 命名空間（`mode`、`preview`、`design_system`、`inputs`、…）擴充此格式，因此同一個成品既能在 CapyDesign 內使用，也能被像 Claude Code、Codex、openclaw 或 hermes 這類原生 Agent 使用。探索作業遵循一條優先順序鏈，因此專案可覆寫自己的技能。",
  ...
  "useEverywhere.section.skills.snippet1":
    "最精簡的 SKILL.md（Claude 相容的前置資料 + CapyDesign 額外設定）",
  ...
  "entry.githubStarAria": "在 GitHub 為 CapyDesign 點亮 Star",
  ...
  "newproj.locationDefault": "CapyDesign 專案",
  ...
  "socialShare.openDesignSection": "分享 CapyDesign",
  "socialShare.openDesignTitle": "GitHub 上的 CapyDesign",
  "socialShare.openDesignText":
    "CapyDesign 是原始碼可用的設計智慧工作區，可以生成、編輯、部署並交付設計產物。",
  ...
  "socialShare.projectText":
    "我用 CapyDesign 做了 {title}。查看已部署產物，也推薦收藏倉庫：{repo}",
  "socialShare.projectCopyText":
    "我用 CapyDesign 做了 {title}\n{url}\nCapyDesign 倉庫：{repo}",
  ...
  "project.imageAgentTooltip": "此專案的圖像與視覺代理",
  "project.imageAgentSection": "圖像與視覺代理",
  "project.imageAgentAuto": "主聊天代理",
  "project.imageAgentAutoHint": "圖像任務在此專案的主聊天代理上執行",
  "project.imageAgentInstalled": "已安裝",
  "project.imageAgentNotInstalled": "未安裝",
  ...
  "chat.conversationsTitle": "歷史會話",
  "chat.conversationsAria": "歷史會話",
  ...
  "chat.brandBrowserAssistDesktopOnly":
    "瀏覽器輔助需要桌面應用，CapyDesign 才能讀取即時瀏覽器頁面。",
  ...
  "chat.brandBrowserAssistMessage":
    "CapyDesign 需要瀏覽器輔助才能完成這次品牌擷取。請先在 Browser 分頁清除頁面攔截，然後在下方確認。",
  "brandEnrichment.title": "AI 優化",
  "brandEnrichment.body":
    "CapyDesign 會在背景執行更深度的抽取，自動套用合適的設計系統 skills，並就地更新這個系統。通常需要 10-20 分鐘，你可以繼續做其他事。",
  ...
  "chat.you": "你",
  "chat.record.retryImage": "剛才有 {count} 張配套插圖沒生成出來,麻煩重新生成一下",
  "chat.quote.add": "加入對話",
  "chat.quote.count": "{count} 條註釋",
  "chat.quote.duplicate": "對話已加入",
  "chat.quote.removeAria": "移除註釋",
  "chat.support.title": "聯絡支援",
  "chat.support.join": "加入",
  "chat.sendFailedRetryAria": "傳送失敗,重試",
  "chat.audio.play": "播放",
  "chat.audio.pause": "暫停",
  "chat.audio.download": "下載 {name}",
  "chat.upgrade.balance": "剩餘額度",
  "chat.upgrade.whyLow": "餘額可能撐不完下一個任務 —— 中途用盡會停在半成品上",
  "chat.upgrade.whyOut": "現在無法開始新任務",
  ...
  "chat.activeFilePlaceholder": "讓 CapyDesign 修改 {file}...",
  ...
  "chat.mode.design.solves":
    "當你希望 CapyDesign 產生檔案、更新 workspace，或把需求變成多模態可交付結果時使用。",
  ...
  "designBrowser.reference.kicker": "CapyDesign 浏览器",
  ...
  "chat.queuedSteerClosed": "這一輪已經停止接收訊息",
  "chat.queuedSteerFailed": "引導對話失敗",
  "chat.queuedSteerTextOnly": "正在跑的這一輪只接得住純文字,這條帶了附件,請單獨發",
  ...
  "preview.shareTextDefault": "CapyDesign 模板：{title}",
  ...
  "preview.errorBody":
    "範例 HTML 載入失敗。請確認 CapyDesign 正在執行後重試。",
  "preview.retry": "重試",
  ...
  "designFiles.documentTemplate.goalBody":
    "說明希望 CapyDesign 基於這份文件生成、修改或判斷什麼。",
  ...
  "designFiles.documentTemplate.capabilityAgent":
    "CapyDesign agent 可以讀取、編輯這份檔案，並把它作為專案上下文。",
  ...
  "designFiles.documentTemplate.nextBody":
    "檢查並編輯這份文件，然後讓 CapyDesign 基於它生成、修改或執行操作。",
  ...
  "designFiles.usefulInfoTip18":
    "在 YouTube 上訂閱 CapyDesign，觀看教學和示範。",
  "designFiles.usefulInfoTip19":
    "在 LinkedIn 上追蹤 CapyDesign，了解產品動態。",
  "designFiles.usefulInfoTip20":
    "在小紅書上追蹤 CapyDesign，獲取技巧和靈感。",
  ...
  "assistant.feedbackReasonTitleNegative": "哪裡不對?",
  "assistant.feedbackDiscordNegative": "到 {discord} 說說具體情況,團隊才能弄清哪裡出了問題並跟進。",
  "assistant.feedbackDiscordPositive": "到 {discord} 社群曬曬你做的東西,或者發張截圖說說哪裡好用。",
  ...
  "assistant.feedbackReasonNegativeMissed": "沒按我說的改",
  "assistant.feedbackReasonNegativeVisual": "視覺不一致",
  "assistant.feedbackReasonNegativeIncomplete": "產物不完整",
  "assistant.feedbackReasonNegativeHard": "不方便使用",
  "assistant.feedbackReasonNegativeCouldNotRun": "跑不起來",
  "assistant.feedbackReasonNegativeTooSlow": "太慢",
  "assistant.feedbackReasonNegativeDesignSystem": "沒有嚴格按照設計系統生成",
  "assistant.feedbackReasonOther": "其他",
  "assistant.feedbackReasonPlaceholder": "補充點什麼(可選)",
  ...
  "chat.runError.actionBlocked.readOnly": "你在這個專案中是唯讀身分，無法發起新任務。",
  "chat.runError.actionBlocked.messagesUnavailable": "這個對話的訊息沒有載入成功，重新載入後才能重試。",
  ...
  "assistant.designSystemDirectionLocked": "已選擇目前的設計系統，視覺方向已鎖定。",
  ...
  "assistant.statusCompactingContext": "正在壓縮上下文",
  "assistant.slowHint":
  ...
  "qf.answered": "已回答",
  "qf.answeredConfirmed": "已確認",
  "qf.answeredSkipped": "已略過",
  "chat.att.cancelUpload": "取消上傳 {name}",
  "chat.att.retry": "重試",
  "chat.attachments.scrollNext": "看後面的附件",
  "chat.attachments.scrollPrev": "看前面的附件",
  "chat.input.collapse": "收合",
  ...
  "chat.edge.reconnectFailed": "網路連線未能恢復",
  "chat.edge.reconnecting": "正在恢復網路連線",
  "chat.edge.retrying": "正在重試",
  "qf.visualNext": "下一張",
  "qf.visualPrev": "上一張",
  "qf.visualRandom": "隨機",
  "qf.visualReshuffle": "換一批",
  "qf.visualViewFan": "疊回一疊",
  ...
  "qf.colorHexLabel": "十六進位顏色值",
  "qf.colorPreview": "預覽:介面裡的強調色會這樣顯示。",
  "qf.colorInvalid": "請輸入 6 位十六進位顏色值,例如 #3b82f6",
  "qf.choose": "請選擇…",
  ...
  "pet.navHint": "領養與自訂",
  "pet.tabBuiltIn": "內建",
  "pet.tabBuiltInHint": "CapyDesign 內建的精選寵物 — 一鍵領養。",
  "pet.builtInEmpty":
  ...
  "pet.codexBundled": "內建",
  "pet.codexBundledTitle": "CapyDesign 內建寵物，無需下載。",
  ...
  "settings.projectLocationsDescription":
    "新增可包含多個 CapyDesign 專案資料夾的工作基目錄。新專案會儲存為所選基目錄中的一個資料夾。",
  ...
  "settings.customInstructionsHint":
    "CapyDesign 在每次聊天中都應遵循的固定指示。將事實、偏好與專案脈絡儲存為記憶。",
  ...
  "artifact.odCardBrandAssistBody":
    "在瀏覽器中開啟品牌網站，讓 CapyDesign 繼續擷取此設計體系。",
  ...
  "updater.activeRunsTitle": "CapyDesign 仍在執行任務",
  "updater.activeRunsBody": "仍有 {count} 個任務正在執行。現在重新啟動會中斷這些任務。",
  "updater.activeRunsUnknownBody": "CapyDesign 無法確認是否仍有任務執行。現在重新啟動可能會中斷進行中的工作。",
  "updater.availableBody":
    "CapyDesign {version} 可用。下載完成後即可開啟安裝器。",
  ...
  "updater.installerOpenBody":
    "安裝器已開啟。CapyDesign 正在結束，以便你完成更新。",
  ...
  "updater.payloadReadyGeneric":
    "A new CapyDesign update is ready. CapyDesign will close and restart automatically.",
  "updater.payloadReadyVersion":
    "CapyDesign {version} is ready. CapyDesign will close and restart automatically.",
  "updater.quitButton": "結束 CapyDesign",
  "updater.quitFailedBody":
    "安裝器已開啟，但 CapyDesign 無法結束。替換應用程式前請先結束 CapyDesign。",
  "updater.quitFailedTitle": "無法結束",
  "updater.quitting": "正在結束…",
  "updater.ready": "更新已就緒",
  "updater.readyGeneric": "新版本已就緒。CapyDesign 會關閉並開啟安裝器。",
  "updater.readyVersion":
    "CapyDesign {version} 已就緒。CapyDesign 會關閉並開啟安裝器。",
  "updater.upToDate": "您已經是最新版本啦",
  "updater.viewVersionFeatures": "查看新版本特色",
  "updater.manualDownload": "手動下載",
  "updater.reinstallLearnMore": "了解詳情",
  "updater.reinstallReadyGeneric": "此更新需要完整重新安裝。CapyDesign 將關閉並開啟安裝程式。",
  "updater.reinstallReadyVersion": "CapyDesign {version} 需要完整重新安裝。CapyDesign 將關閉並開啟安裝程式。",
  "updater.restartAnyway": "仍然重新啟動",

  "whatsNew.updatedTitle": "CapyDesign {version} 已更新",
  "whatsNew.cta": "查看更新說明",
  ...
  'settings.updateQuitFailed': '安裝程式已開啟，但 CapyDesign 未能自動結束。',
  ...
  "dsManager.createBody":
    "把你的品牌、產品、程式碼、素材與設計參考教給 CapyDesign。",
  ...
  "settings.customInstructionsDesc":
    "CapyDesign 在每次對話中都會遵循的固定指令。它們不是儲存的記憶；事實、偏好與專案脈絡請使用「記憶」。",
  ...
  "brand.librarySubtitle":
    "把你的品牌套件教給 CapyDesign——從網站擷取一個品牌套件，然後在任意對話中套用它。",
  ...
  "onboarding.buildBody":
    "CapyDesign 將你的品牌沉澱為可重用的設計系統,讓你之後打造的一切都保持品牌一致。",
  ...
  "dsCreate.sourceSectionBody":
    "從 GitHub repo、網站、DESIGN.md 或能體現風格的檔案開始。CapyDesign 會先快速建立一套可用系統，之後 AI 可在專案中繼續細化。",
  ...
  "ds.extractionRunningBody": "CapyDesign 正在就地更新此體系。",
  ...
  "ds.repoConnectBannerBody":
    "連接 GitHub 後，CapyDesign 可以讀取你的儲存庫，並把顏色、字體和元件擷取到此設計體系中。",
  ...
  'library.getClipper': '取得 CapyDesign 網頁剪藏擴充功能',
  ...
  'library.emptyHintBefore': '用 CapyDesign 網頁剪藏擴充功能從任意網頁收藏，執行',
  ...
  'mcp.checking': '檢查中…',
  'mcp.clickConnectHint': '點擊「連線」，透過服務商的 OAuth 流程授予 CapyDesign 存取權限。',
  ...
  'mcp.noManagedOAuthSaveDirect': '儲存此伺服器後，CapyDesign 會直接使用它。',
  'mcp.noManagedOAuthUseAsConfigured': 'CapyDesign 會依你的設定使用此伺服器。如果伺服器需要 token，請在下方新增標頭。',
  ...
  'mcp.starting': '啟動中…',
  'mcp.toGrantOAuthAccess': '透過服務商的 OAuth 流程授予 CapyDesign 存取權限。',
  ...
  'memory.extractionSourceConnector': '已讀取已連接的應用程式，但 CapyDesign 無法將這些上下文轉化為記憶。',
  'memory.extractionSourceChat': 'CapyDesign 無法為這次對話執行記憶擷取。',
  ...
  'memory.noSuggestionsFound': '未找到記憶建議。CapyDesign 暫時無法從所選應用程式中讀取到有用的內容。',
  ...
  'memory.chooseSourcesHint': '請先選擇已連接的應用程式。CapyDesign 只會掃描你選取的應用程式。',
  ...
  'dsCreate.confirmTitle': 'CapyDesign 將擷取你的設計系統。',
  ...
  'dsCreate.githubMethodOdAccount': 'CapyDesign 帳號',
  'dsCreate.githubMethodOdAccountDesc': '由 CapyDesign 管理的原生 GitHub 登入；此版本尚未使用 OD 託管的 GitHub 權杖。',
  ...
  'dsFlow.activityRunningTitle': 'CapyDesign 正在更新此設計系統',
  ...
  'dsFlow.jobRebuildingTokens': 'CapyDesign 正在重建 token',
  'dsFlow.jobRevising': 'CapyDesign 正在修訂',
  'dsFlow.jobStillWorking': 'CapyDesign 仍在處理中',
  ...
  'dsFlow.pickLocalAgentFirst': '請先選擇一個本機代理，然後讓 CapyDesign 更新這個設計系統。',
  'dsFlow.previewPages': '預覽頁面',
  'dsFlow.proposedChanges': '建議的變更',
  'dsFlow.publishCardReady': 'CapyDesign 已可供審閱。請對目前的成果給出回饋，確認它對後續專案有用後再發布。',
  'dsFlow.publishCardRevision': 'CapyDesign 正在套用你的回饋。在準備更新草稿期間，你可以繼續審閱。',
  'dsFlow.publishCardTokenRebuild': 'CapyDesign 正在準備一份供審閱的 token 契約重建。在你接受之前，目前生效的契約保持不變。',
  'dsFlow.publishCardWorking': 'CapyDesign 仍在處理中，但你已經可以對目前的成果給出回饋。',
  ...
  'pluginDetail.officialBadge': 'CapyDesign 官方',
  ...
  'campaign.deepseekV4Flash.boundary': '方案內的無限制模型額度與免費生成次數，僅可透過 CapyDesign 使用；無法在 MCP/CLI/API 及其他場景使用。解釋權歸官方所有。部分模型尖峰時段需要排隊。',
  ...
  'experienceSurvey.tag': "期待您的回饋，與我們一起完善 CapyDesign",
  'experienceSurvey.close': "關閉",
  'experienceSurvey.recommendation': "你有多大可能把 CapyDesign 推薦給同事或朋友？",
  'experienceSurvey.recommendationLow': "完全不會",
  'experienceSurvey.recommendationHigh': "一定會",
  'experienceSurvey.improvement': "你最希望我們優先改進哪一項？",
  'experienceSurvey.improvement.wrongOutput': "做的不是我要的東西",
  'experienceSurvey.improvement.falseDone': "說做好了，但沒變化",
  'experienceSurvey.improvement.hardToUse': "用起來不順手",
  'experienceSurvey.improvement.upgradePrompts': "付費彈窗太多",
  'experienceSurvey.improvement.stuck': "中途卡住或失敗",
  ...
  'experienceSurvey.improvement.other': "其他",
  'experienceSurvey.otherPlaceholder': "說說你遇到的情況",
  ...
  'chat.record.verb.read': "讀取",
  'chat.record.verb.write': "新增",
  'chat.record.verb.edit': "改寫",
  'chat.record.verb.search': "搜尋",
  ...
  'chat.record.viewLarge': "查看大圖",
  'chat.record.imagePending': "配圖生成中",
  'chat.record.audioBatch': "生成配套音訊",
  'chat.record.videoBatch': "生成配套影片",
  'chat.record.audioCount': "{count} 段",
  'chat.record.videoCount': "{count} 部",
  'chat.record.audioPending': "音訊生成中",
  'chat.record.videoPending': "影片生成中",
  'chat.record.viewAudio': "播放第 {index} 段音訊",
  'chat.record.viewVideo': "播放第 {index} 部影片",
  'chat.designSystemStatus.title': "正在創建設計系統工作區",
  'chat.designSystemStatus.description': "CapyDesign 正在使用設定的來源生成此專案。",
  'labs.title': "CapyDesign 實驗室",
  ...
  'labs.harnessHint': "開啟後，下次生成將使用 CapyDesign 最新生成策略，生成效果更精緻（內測中）",
  'labs.harnessTooltip': "開啟後改用 CapyDesign 為設計場景打造的 agent harness，產物在版面、結構與完成度上會明顯更好。",
