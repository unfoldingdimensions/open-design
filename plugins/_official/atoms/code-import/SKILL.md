...
real repo (cloned via `capt project import` or a path the user
...
| --- | --- | --- |
| `repoPath` | yes | Absolute path to the repo's root, supplied via `capt project import` or an upstream `od.context.assets[]` reference |
