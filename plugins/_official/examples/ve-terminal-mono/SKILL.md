...
description: |
  OpenDesign from the CLI: driving the full design workflow with the `capt` command — scripted, composable, agent-ready. Built as a decision-grade AI literacy deck for developers, power users.
en_description: |
  OpenDesign from the CLI: driving the full design workflow with the `capt` command — scripted, composable, agent-ready. Built as a decision-grade AI literacy deck for developers, power users.
zh_description: |
