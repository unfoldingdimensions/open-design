...
- MCP live artifacts are currently generated by `buildLiveArtifactsMcpServersForAgent`, which creates the `capt mcp live-artifacts` server config when `def.mcpDiscovery === 'mature-acp'`. Source: `apps/daemon/src/agents.ts:1111-1121`
