...
The packet should be inspectable in UI and available to `capt automation`.
...
|---|---|---|
| List templates | Automations template picker | `capt automation template list --json` |
| Run ingestion | Automations "Ingest source" panel | `capt automation source ingest --source-kind <kind> --body-file <path|-> --json` |
| Inspect source packets | Recent ingestions list | `capt automation source list/get --json` |
| Review proposals | Review drawer with diff and apply/reject | `capt automation proposal list/apply/reject --json` |
| Edit memory tree | Settings -> Memory tree | `capt memory tree ... --json` |
| Manage token compression | Ingestion compression selector | `capt automation source ingest --compression off|balanced|aggressive --json` |
| Promote design system | Evolution proposal apply action | `capt automation proposal apply <proposal> --json` |
| Crystallize skill | Evolution proposal apply action | `capt automation proposal apply <proposal> --json` |
...
- Add `capt memory tree list/view/edit/move` and matching Settings UI.
...
- `capt memory tree list/view/edit/move` mirrors the Settings memory-tree view so
...
- Update the existing Automations page and `capt automation` commands to present
...
- `capt automation proposal list/get/apply/reject` mirrors the UI review path.
...
- `capt automation source ingest/list/get` mirrors the Automations source panel.
