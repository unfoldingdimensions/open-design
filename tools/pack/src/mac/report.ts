...
export async function collectMacSizeReport(
  ...
  return {
    ...
    tracked: {
      ...
      webNextCacheBytes: await sizePathBytes(join(appNodeModulesRoot, "@capydesign", "web", ".next", "cache")),
      webPackageBytes: await sizePathBytes(join(appNodeModulesRoot, "@capydesign", "web")),
      webPackageStandaloneBytes: await sizePathBytes(join(appNodeModulesRoot, "@capydesign", "web", ".next", "standalone")),
    },
